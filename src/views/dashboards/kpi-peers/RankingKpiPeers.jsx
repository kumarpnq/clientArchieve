  ...
  const handleMenuClick = menuItem => {
    switch (menuItem) {
      ...
      case 'table':
        ...
        break
      case 'image':
        toBlob(document.getElementById('ranking-kpi-peers')).then(function (blob) {
          const url = window.URL.createObjectURL(blob)
          const a = document.createElement('a')
          a.href = url
          a.download = 'ranking-kpi-peers.png'
      ...
      case 'pdf':
        ...
        toBlob(document.getElementById('ranking-kpi-peers')).then(function (blob) {
          ...
          img.onload = function () {
            ...
            doc.save('ranking-kpi-peers.pdf')
      ...
      case 'xlsx':
        if (chartData) {
          ...
          XLSX.utils.book_append_sheet(wb, ws, `ranking-kpi-peers Data`)
          XLSX.writeFile(wb, `ranking-kpi-peers.xlsx`)
        }
        break
      default:
        break
            ...
            <Box>
              ...
              <Menu keepMounted anchorEl={anchorEl} onClose={handleClose} open={Boolean(anchorEl)}>
                {asPath === '/dashboards/custom/' ? (
                  <MenuItem onClick={() => handleRemoveFromChartList('RankingKpiPeers')}>Remove from Custom</MenuItem>
                ) : (
...
export default RankingKpiPeers

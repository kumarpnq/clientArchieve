  ...
  const handleMenuClick = menuItem => {
    switch (menuItem) {
      ...
      case 'table':
        ...
        break
      case 'image':
        toBlob(document.getElementById('publication-visibility')).then(function (blob) {
          const url = window.URL.createObjectURL(blob)
          const a = document.createElement('a')
          a.href = url
          a.download = 'publication-visibility.png'
      ...
      case 'pdf':
        ...
        toBlob(document.getElementById('publication-visibility')).then(function (blob) {
          ...
          img.onload = function () {
            ...
            doc.save('publication-visibility.pdf')
      ...
      case 'xlsx':
        if (chartData) {
          ...
          XLSX.writeFile(wb, 'publicationVisibility.xlsx')
        }
        break
      default:
        break
  ...
  return (
    <>
      ...
      <Card sx={{ height: '100%' }}>
        ...
        <CardContent onClick={handleChartClick} id='publication-visibility'>
          {loading ? (
            <Box>
              <CircularProgress />
            </Box>

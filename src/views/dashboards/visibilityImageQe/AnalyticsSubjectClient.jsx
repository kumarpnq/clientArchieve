  ...
  const handleMenuClick = menuItem => {
    switch (menuItem) {
      ...
      case 'table':
        ...
        break
      case 'image':
        toBlob(document.getElementById('subject-client')).then(function (blob) {
          const url = window.URL.createObjectURL(blob)
          const a = document.createElement('a')
          a.href = url
          a.download = 'subject-client.png'
      ...
      case 'xlsx':
        if (chartData) {
          ...
          XLSX.writeFile(wb, 'subject-client.xlsx')
        }
        break
      default:
        break
  ...
  return (
    <>
      ...
      <Card sx={{ height: '100%' }}>
        ...
        <CardContent onClick={handleChartClick} id='subject-client'>
          {loading ? (

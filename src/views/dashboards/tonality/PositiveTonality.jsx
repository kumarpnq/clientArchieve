  ...
  const handleMenuClick = menuItem => {
    switch (menuItem) {
      ...
      case 'table':
        ...
        break
      case 'image':
        toBlob(document.getElementById('positive-tonality')).then(function (blob) {
          const url = window.URL.createObjectURL(blob)
          const a = document.createElement('a')
          a.href = url
          a.download = 'positive-tonality.png'
      ...
      case 'pdf':
        ...
        toBlob(document.getElementById('positive-tonality')).then(function (blob) {
          ...
          img.onload = function () {
            ...
            doc.save('positive-tonality.pdf')
...
export default PositiveTonality

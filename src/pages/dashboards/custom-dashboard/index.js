...
const layouts = {
  lg: [
    { i: 'item1', x: 0, y: 0, w: 6, h: 25 }, // lg width is 10
    { i: 'item2', x: 6, y: 0, w: 6, h: 25 },
    { i: 'item3', x: 12, y: 0, w: 4, h: 50 },
    { i: 'item4', x: 0, y: 4, w: 12, h: 25 },
    { i: 'item5', x: 0, y: 8, w: 8, h: 25 },
    { i: 'item6', x: 8, y: 8, w: 8, h: 25 }
  ],
  md: [
    { i: 'item1', x: 0, y: 0, w: 10, h: 25 }, // lg width is 10
    { i: 'item2', x: 0, y: 8, w: 10, h: 25 },
    { i: 'item3', x: 10, y: 0, w: 6, h: 50 },
    { i: 'item4', x: 0, y: 0, w: 16, h: 25 },
    { i: 'item5', x: 0, y: 0, w: 16, h: 25 },
    { i: 'item6', x: 6, y: 0, w: 16, h: 25 }
  ],
  sm: [
    { i: 'item1', x: 0, y: 0, w: 9, h: 25 }, // lg width is 10
    { i: 'item2', x: 0, y: 0, w: 9, h: 25 },
    { i: 'item3', x: 9, y: 0, w: 7, h: 50 },
    { i: 'item4', x: 0, y: 0, w: 16, h: 25 },
    { i: 'item5', x: 0, y: 0, w: 16, h: 25 },
    { i: 'item6', x: 0, y: 0, w: 16, h: 25 }
  ],
  xs: [
    { i: 'item1', x: 0, y: 0, w: 16, h: 25 }, // lg width is 10
    { i: 'item2', x: 0, y: 0, w: 16, h: 25 },
    { i: 'item3', x: 8, y: 0, w: 16, h: 50 },
    { i: 'item4', x: 0, y: 0, w: 16, h: 25 },
    { i: 'item5', x: 0, y: 0, w: 16, h: 25 },
    { i: 'item6', x: 0, y: 0, w: 16, h: 25 }
  ]

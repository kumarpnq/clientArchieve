...
import { Language, PEERS_VOLUME_VISIBILITY, Print, ReportingTone } from 'src/constants/filters'
...
function ThemePerformance() {
  ...
  const { data, loading } = useChartAndGraphApi(PEERS_VOLUME_VISIBILITY, selectMediaType, ReportingTone)
